...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/webjars/prototype/1.7.1.0/prototype.js"></script>
		<script type="text/javascript" src="${ctx}/javascript/codemonkey-activiti/oryx.debug.js"></script>
