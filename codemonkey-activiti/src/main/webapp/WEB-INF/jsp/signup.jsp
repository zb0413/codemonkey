...
<link rel="stylesheet" href="${ctx}/css/bootstrap-custom/sticky-footer-navbar.css"/>

<!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
<script type="text/javascript" src="${ctx}/javascript/bootstrap-custom/ie-emulation-modes-warning.js"></script>
...
<script type="text/javascript" src="${ctx}/javascript/bootstrap-custom/ie10-viewport-bug-workaround.js"></script>

<link rel="stylesheet" href="${ctx}/css/bootstrap-custom/login.css"/>

</head>
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top header">
		<div class="container">
			<a class="navbar-brand text3D">医院绩效管理系统</a>
		</div>
	</nav>
