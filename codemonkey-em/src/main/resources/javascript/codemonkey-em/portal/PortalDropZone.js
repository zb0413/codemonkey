/**
 * @class AM.portal.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Ext.app.PortalPanel}.
 */
Ext.define('AM.portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        AM.portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        AM.portal.PortalDropZone.superclass.unreg.call(this);
    }
});
