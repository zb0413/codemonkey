...
import com.codemonkey.SampleWsApplication;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = SampleWsApplication.class , locations={ "classpath*:spring/applicationContext-*.xml" })
@WebAppConfiguration
